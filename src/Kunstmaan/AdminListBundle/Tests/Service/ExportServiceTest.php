...
class ExportServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetSupportedExtensions()
    {
        ...
        $this->assertSame(['Csv' => 'csv', 'Excel' => 'xlsx'], $extensions);
    }
    ...
    public function testCreateFromTemplate($template = null)
    {
        ...
        $templateName = null === $template ? 'KunstmaanAdminListBundle:Default:export.csv.twig' : $template;
    ...
    public function createFromTemplateProvider()
    {
        return [
            [null],
            ['MyBundle:Default:export.csv.twig'],
        ];
    }
