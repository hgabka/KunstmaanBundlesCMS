...
class RedirectAdminTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $multiDomainConfiguration->expects($this->any())->method('getHosts')->will($this->returnValue(['domain.com', 'domain.be']));
        ...
        $singleDomainConfiguration->expects($this->any())->method('getHosts')->will($this->returnValue([]));
